...
*/
    ...
    public static void main(String[] args) {
        ...
        bob.addMyObserver(larry);
        bob.addMyObserver(camille);

        // devin is responsible for haydar and stimpy
        haydar.addMyObserver(devin);
        stimpy.addMyObserver(devin);

        // camille is also responsible for stimpy
        stimpy.addMyObserver(camille);

        // only larry is responsible for joe's well being
        joe.addMyObserver(larry);
