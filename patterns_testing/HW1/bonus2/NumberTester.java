...
public class NumberTester{
	...
	public void testConstruction(){
		...
		//realnumbers
		assertEquals(0, realNumber1.getNumber(), TOLERANCE);
		assertEquals(15, realNumber2.getNumber(), TOLERANCE);
		assertEquals(-50, realNumber3.getNumber(), TOLERANCE);
		assertEquals(2.5, realNumber4.getNumber(), TOLERANCE);
		assertEquals(-4.5, realNumber5.getNumber(), TOLERANCE);
	...
	public void testRealOnlySubtract(){
		...
		assertEquals(-52.5, realHolder.getNumber(), TOLERANCE);
		
		//subtract 4 and 5, check values
		realHolder = realNumber4.subtract(realNumber5);
		assertEquals(7, realHolder.getNumber(), TOLERANCE);
	}
	//complex and real
	@Test
	...
	public void testRealOnlyDivide(){
		...
		assertEquals(-20, realHolder.getNumber(), TOLERANCE);
		
		//divide 4 and 5, check values
		realHolder = realNumber4.divide(realNumber5);
		assertEquals(-0.5556f, realHolder.getNumber(), TOLERANCE);
	}
	//complex and real
	@Test
